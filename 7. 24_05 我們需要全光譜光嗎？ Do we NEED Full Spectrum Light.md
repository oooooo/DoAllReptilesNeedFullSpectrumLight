...
棲息地的太陽比例 + 演化而來的皮膚、活動時間，讓牠吸收了剛好的 UVB。
UVB 將皮膚中膽固醇轉化為 pre-d3；同時，"足夠的溫暖" 將 pre-D3 轉化為 D3 (D3 合成是兩階段的)。
...
地球的大氣層過濾掉了所有非常短的波長，
只允許大約從 295 毫米以上的一些 UVB 透過，只有一點點，很大量的 UVA；
超大量可見光；
大量的 IR-A 和一點點 IR-B。
...
<!-- #動物反應實驗實驗 1: 利氏壁蜥認知光與溫暖 -->

---

<!-- 動物反應實驗實驗 2: 環頸蜥 3 燈評估 -->

30:56
Now Ron Murrin has just done some trials with collared lizards,
現在 Ron Murrin 剛剛對環頸蜥做了一些試驗，
...
壁虎在他們偏好體溫之中有一種晝夜節律，所以他們會在日夜改變他們的體溫，
